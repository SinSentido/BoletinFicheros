...
public class Ejercicio7Cipher {
    public static void main(String[] args){
        ...
        do{
            System.out.println("Write the path of the file you want to cypher");
            path = kbd.nextLine();
            file = new File(path);
        ...
        System.out.println("Write the password to cifrate the file");
